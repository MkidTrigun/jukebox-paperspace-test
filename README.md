...
**Current status: Using Python3 kernel, I have been able to run the 5b_lyrics model to generate three 60-second samples and have them upsampled to Level 0 within the six hour auto-shutdown window on Free-A4000 tier of GPU (requiring Paperspace Pro subscription)**
