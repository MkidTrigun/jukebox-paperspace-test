...
**Current status: Using Python3 kernel, have been able to run 5b_lyrics model (for Level 2 generation, upsampling in progess) on Free-A4000 tier of GPU (requiring Paperspace Pro subscription), further testing in progress**
